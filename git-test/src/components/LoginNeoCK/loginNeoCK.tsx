...
interface LoginNeoCKProps {
  onLoginSuccess: () => void;
}

const LoginNeoCK: React.FC<LoginNeoCKProps> = ({ onLoginSuccess }) => {
    ...
    <>
      <StyledCardContainer>
        <StyleLoginCard>
          ...
          <StyledLoginButton size="large" color="primary" variant="contained" onClick={handleLogin}>
            INICIAR SESIÓN
          </StyledLoginButton>
        </StyleLoginCard>
      </StyledCardContainer>
